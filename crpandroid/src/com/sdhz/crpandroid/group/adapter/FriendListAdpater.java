...
public class FriendListAdpater  extends BaseAdapter{
	...
	public FriendListAdpater(List<UserInfo> itemsList, Context mcontext) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			convertView=LayoutInflater.from(mcontext).inflate(R.layout.crp_friendfragment_item, null);
